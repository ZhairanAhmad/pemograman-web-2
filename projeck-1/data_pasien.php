                                    ...
                                    <table class="table table-head-fixed table-responsive-lg">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($query as $row) {
                                                ...
                                                echo "<td><a href='edit_pasien.php?id=" . $row['id'] . "' class='btn btn-info' style='margin-right: 5px;'>Edit</a>";
                                                echo "<a href='delete_pasien.php?id=" . $row['id'] . "' class='btn btn-danger'>Delete</a></td>";
                                                echo "</tr>";
                                            }
                                            ?>
                                        </tbody>
