 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
     ...
     <a href="#" class="brand-link">
         ...
         <span class="brand-text font-weight-light">projek uts</span>
     </a>
     ...
     <div class="sidebar">
         ...
         <div class="user-panel mt-3 pb-3 mb-3 d-flex">
             <div class="image">
                 <img src="dist/img/p.png" class="img-circle elevation-2" alt="User Image">
             </div>
             <div class="info">
                 <a href="#" class="d-block">Zhairan Ahmad Ukasyah</a>
             </div>
         </div>
